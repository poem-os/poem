...
1. **POEM vs SupportSignal BMAD Comparison** - Cross-project gap analysis
2. **Real-World Usage Feedback** - POEM usage issues from field testing

**Output**: BMAD agents (Analyst, SM) will analyze observations and generate stories for POEM backlog.

---

## Gap Analysis Structure (Option A: Single Source of Truth)

### Core Documents

| File | Location | Purpose |
|------|----------|---------|
| **`bmad-core-gap-analysis.md`** | **POEM (this repo)** | ⭐ **SOURCE OF TRUTH** - Central comparison of POEM vs SupportSignal BMAD implementations |
| `action-items.md` (POEM) | POEM (this repo) | What POEM should adopt from SupportSignal |
| `action-items.md` (SS) | SupportSignal repo | What SupportSignal should adopt from POEM |

### SupportSignal Reference

SupportSignal's `bmad-core-gap-analysis.md` is a **redirect file** pointing to POEM's source of truth.

**Why this structure?**
- Prevents duplication and version drift
- POEM maintains the central comparison (30KB, updated Jan 22)
- Each project maintains its own adoption roadmap

### Usage Issues (POEM-Specific)

| File | Purpose |
|------|---------|
| `usage-issues.jsonl` | JSONL log of issues discovered during real-world POEM usage (14 issues) |
| `usage-issues.schema.json` | Schema for usage issue tracking (v2.1 with field testing support) |
| `usage-issues-guide.md` | How to log and triage usage issues |
