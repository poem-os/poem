...
├── docs/                      # Documentation
│   └── claude-md-guide.md     # NEW: Agent documentation (created by this story)
└── poem-core-config.yaml      # Core configuration
...
- **Epic 3**: Prompt Engineering (Penny agent details, Victor agent details)

## Future Considerations

- Auto-update CLAUDE.md during installation (Epic 9?)
