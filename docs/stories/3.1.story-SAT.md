...
- `.claude/commands/poem/agents/prompt-engineer.md`

**Working directory**: `/Users/davidcruwys/dev/ad/poem-os/poem`

---

## 🤖 Terminal Tests (File Verification)
...
```bash
grep -c "<!-- Powered by BMAD™ Core -->" packages/poem-core/agents/prompt-engineer.md && \
...
- ✅ BMAD header present
- ✅ IDE-FILE-RESOLUTION section exists
- ✅ REQUEST-RESOLUTION section exists
...
- ✅ new command defined
- ✅ refine command defined
- ✅ test command defined
- ✅ validate command defined
- ✅ exit command defined (6 total)
...
- ✅ poem-principles.md exists
- ✅ prompt-best-practices.md exists
- ✅ Agent activation-instructions reference data file
...
```bash
ls -la .claude/commands/poem/agents/prompt-engineer.md && \
head -5 .claude/commands/poem/agents/prompt-engineer.md
```

**Expected Output**:

```
-rw-r--r--  1 user  staff  XXXX  Dec 30 XX:XX .claude/commands/poem/agents/prompt-engineer.md
...
- ✅ Contains correct command header
- ✅ Contains agent persona instruction
- ✅ Contains BMAD header

**Status**: ✅ Passed

**Notes**: File exists (5267 bytes), correct header "# /poem/agents/prompt-engineer Command"
...
**What to test**: `/poem/agents/prompt-engineer` slash command activates the agent

**Steps**:

1. Open a new Claude Code session in the poem project directory
2. Type: `/poem/agents/prompt-engineer`
3. Press Enter
...
- new → references new-prompt.yaml workflow
- refine → references refine-prompt.yaml workflow
- test → references test-prompt.yaml workflow
- validate → references validate-prompt.yaml workflow
...
- [x] Test A: Agent definition file exists ✅
- [x] Test B: BMAD structure present ✅
- [x] Test C: Persona defined correctly ✅
- [x] Test D: Commands listed ✅
- [x] Test E: Data files exist and referenced ✅
- [x] Test F: Slash command wrapper exists ✅
...
**Overall Status**: 🔄 In Progress (Terminal: 6/6 passed, Human: 0/4 pending)
...
**Symptom**: `/poem/agents/prompt-engineer` returns "command not found"
**Solution**: Ensure `.claude/commands/poem/agents/prompt-engineer.md` exists and Claude Code has been restarted to pick up new commands.
...
**Sign-off**: ⏳ Pending Human Tests | ✅ Story accepted | ❌ Issues require fixes
