...
- ✅ File `docs/backlog/quick-fixes.md` exists
- ✅ Header is "# Quick Fixes" (not "Maintenance Backlog")
- ✅ Description mentions "<1 hour" scope
- ✅ Old file `docs/backlog/maintenance.md` does NOT exist
...
- ✅ `maintenance.backlogFile` points to `docs/backlog/quick-fixes.md`
- ✅ No references to `maintenance.md` remain
...
- ✅ `list-fixes` command exists (not `list-maint`)
- ✅ `add-fix` command exists (not `add-maint`)
- ✅ Commands reference "quick fixes backlog"
...
- ✅ File `.bmad-core/tasks/triage-work.md` exists
- ✅ Contains "Decision Criteria" section
- ✅ Contains "Routing Paths" section
- ✅ Contains "Handoff Templates" section
- ✅ File is substantial (>10KB)
...
- ✅ Decision tree shows 4 criteria (Time/Ceremony, Existing Story, Epic Fit, Epic 0)
- ✅ Logic flows from criterion 1 → 2 → 3 → 4
- ✅ Each criterion has branching logic
...
```bash
grep -c "🔍 Work Intake Triage\|✓ Found:\|✅ RECOMMENDED:" .bmad-core/tasks/triage-work.md
```
...
- ✅ Output format template includes visual headers (🔍, ✅, 🔀)
- ✅ Includes analysis section (Found, Area, Estimate, Impact, Type)
- ✅ Includes routing decision section
...
- ✅ File `.claude/commands/triage.md` exists (NOT in `/poem/` subdirectory)
- ✅ File is thin wrapper (~30-80 lines)
- ✅ References `.bmad-core/tasks/triage-work.md`
...
- ✅ Documents `/triage` format (conversation-based)
- ✅ Documents `/triage issue-{N}` format (usage issue)
...
- ✅ `triage` command appears in Bob's commands list
- ✅ Description is "Analyze work and route to appropriate workflow"
- ✅ References `triage-work.md` task
- ✅ `triage-work.md` listed in dependencies section
...
- ✅ `triage` command appears in Sarah's commands list
- ✅ Description matches Bob's description
- ✅ References `triage-work.md` task
- ✅ `triage-work.md` listed in dependencies section
...
- ✅ File `docs/workflows/triage-guide.md` exists
- ✅ Contains "Overview" section
- ✅ Contains "When to Use" section
- ✅ Contains "Decision Criteria Explained" section
- ✅ Contains "FAQ" section
- ✅ File is substantial (150-250 lines)
...
- ✅ Contains examples for Path #1 (Existing Story)
- ✅ Contains examples for Path #2 (Feature Epic Story)
- ✅ Contains examples for Path #3 (Quick Fixes)
- ✅ Contains examples for Path #4 (Epic 0 Story)
- ✅ Contains examples for Path #5 (Usage Issue)
- ✅ Each path has scenario and output example
...
- ✅ Contains ASCII art decision tree
- ✅ Shows branching logic visually
- ✅ Includes all 4 decision criteria nodes
...
- ✅ Detects `/triage issue-{N}` format
- ✅ References `docs/planning/gap-analysis/usage-issues.jsonl`
- ✅ Includes JSONL parsing logic
- ✅ Handles missing file gracefully
- ✅ Handles resolved issues
...
- ✅ Specifies expected file path
- ✅ Offers fallback to conversation triage
...
```bash
grep -A 3 "### Quick Fixes vs Epic 0 Stories" docs/prd/epic-0-process.md
```
...
- ✅ Section "Quick Fixes vs Epic 0 Stories" exists
- ✅ Defines Quick Fixes (<1 hour, no ceremony)
- ✅ Defines Epic 0 Stories (>1 hour, full ceremony)
- ✅ Includes promotion guidance (Quick Fix → Epic 0)
...
```bash
head -3 docs/prd/epic-0-process.md
```
...
- ✅ Header is "# Epic 0: Maintenance & Continuous Improvement"
- ✅ No naming collision with "Quick Fixes"
...
- ✅ `.bmad-core/tasks/triage-work.md` exists
- ✅ `.claude/commands/triage.md` exists
- ✅ `docs/workflows/triage-guide.md` exists
- ✅ `docs/backlog/quick-fixes.md` exists (renamed from maintenance.md)
...
- ✅ File `docs/backlog/maintenance.md` does NOT exist
- ✅ Renamed to `docs/backlog/quick-fixes.md`
...
- ✅ Test B: Core config updated to docs/backlog/quick-fixes.md
- ✅ Test C: Bob (SM) commands renamed (list-fixes, add-fix)
- ✅ Test D: Sarah (PO) commands renamed (list-fixes, add-fix)
- ✅ All 4 key files created and verified:
...
**Sign-off**: ✅ Story accepted - All acceptance criteria validated
