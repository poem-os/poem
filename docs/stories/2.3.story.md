...
| 2025-12-28 | 0.5 | Added .d.ts type declarations for TypeScript support | James (Dev Agent) |
| 2025-12-28 | 0.6 | Added gitleaks + husky for secret detection (infrastructure gap found during QA) | Quinn (QA Agent) |
...
- Added .d.ts type declarations for all helpers (TypeScript strict mode compliance)
- Infrastructure: Added gitleaks + husky pre-commit hook for secret detection
- Infrastructure: Added .astro/ to .gitignore (was missing)
