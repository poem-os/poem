...
- [Helper Metadata API Discovery (Epic 4)](../kdd/learnings/epic4-helper-metadata-api-discovery.md)

**Decisions (ADRs)**:
- [ADR-007: ESM Helpers with Hot Reload](../kdd/decisions/adr-007-esm-helpers-hot-reload.md)
