...
**Patterns**: None (Handlebars service tests story)

**Examples**: None

**Learnings**:
- [Slash Command Source Duplication](../../kdd/learnings/slash-command-source-duplication.md) - Discovered during Task 10: `.claude/commands/` must be synced from `packages/poem-core/commands/` to avoid drift
- [Hot-Reload Production Mode](../../kdd/learnings/hot-reload-production-mode.md) - Hot-reload should be disabled in production; dev-only feature
