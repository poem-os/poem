...
This directory contains agent-interpreted task definitions for POEM.

## Path Resolution Pattern

**CRITICAL: Tasks do NOT define paths - config is the source of truth.**

### Why This Matters

Previously, each task duplicated path definitions:
```yaml
# BAD - Don't do this!
paths:
  development:
...
- Maintenance burden for future tasks

### The Pattern

Tasks inherit paths from `poem-core-config.yaml`:
...
When executing a task, agents should:
