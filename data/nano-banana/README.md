...
**Status**: 🔬 Research & Data Collection Phase (Step 1)
...
## Current Phase: Step 1 - Organize Raw Data

**Goal**: Build up the knowledge base and reference materials before creating prompts.

**What goes here:**
- Example prompts you've used or found
- Camera angle definitions and vocabulary
- Shot type classifications
- Storytelling beat structures
- Visual style references
- Any existing workflows or processes
