...
**Purpose**: Maps fields from different data sources to template placeholders
...
- Agent can validate mappings against schemas

---

## Example Files in This Folder

These are **reference examples only** to show the pattern. Create actual mapping files on-demand when needed.
