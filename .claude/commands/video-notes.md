---
description: Generate AppyDave video notes (.AD.md) with talking points and image prompts from step documentation
---
...
Execute the agent workflow on the input file.
